...
try:
    ...
    print("[OK] Switch 3700 errors cleared")
    sw.close()
except Exception as e:
    print(f"[FAIL] Switch 3700: {e}")
...
try:
    ...
    cs.timeout = 5000
    cs.write("*CLS")
    print("[OK] Current Source 6221 errors cleared")
    cs.close()
except Exception as e:
    print(f"[FAIL] Current Source 6221: {e}")
...
try:
    ...
    pm.timeout = 5000
    pm.write("*CLS")
    print("[OK] Picoammeter 6487 errors cleared")
    pm.close()
except Exception as e:
    print(f"[FAIL] Picoammeter 6487: {e}")
